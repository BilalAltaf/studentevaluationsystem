...
public partial class student_subject_project_result : System.Web.UI.Page
{
    ...
    public int a;
    public int d;
    public void show_project_result()
    {
        ...
        cmd.CommandText = "select count(total_project) from subject_result where srs_id=(select srs_id from student_registered_courses where s_id='" + s_id + "' && su_id='" + su_id + "')";
        ...
        if (b == 1)
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                for (int j = 0; j < a; j++)
                {
                    ...
                    if (j == 0)
                    {
                        tc.Text = "Project#1 Total Marks";
                    }
                    else if (j == 1)
                    {
                        tc.Text = "Project#1 Total Obtained Marks";
                    }
                    else if (j == 2)
                    {
                        tc.Text = "Project#2 Total Marks";
                    }
                    else if (j == 3)
                    {
                        tc.Text = "Project#2 Total Obtained Marks";
                    }
                    else if (j == 4)
                    {
                        tc.Text = "Project#3 Total Marks";
                    }
                    else if (j == 5)
                    {
                        tc.Text = "Project#3 Total Obtained Marks";
                    }
                    else if (j == 6)
                    {
                        tc.Text = "Project#4 Total Marks";
                    }
                    else if (j == 7)
                    {
                        tc.Text = "Project#4 Total Obtained Marks";
                    }
                    else if (j == 8)
                    {
                        tc.Text = "Project#5 Total Marks";
                    }
                    else if (j == 9)
                    {
                        tc.Text = "Project#5 Total Obtained Marks";
                    }
                    tc.Font.Bold = true;
                    tr.Cells.Add(tc);
                    tc.BorderWidth = 1;
            ...
            cmd1.CommandText = "select p1,total_p1_marks,p2,total_p2_marks,p3,total_p3_marks,p4,total_p4_marks,p5,total_p5_marks from subject_result where srs_id=(select srs_id from student_registered_courses where s_id='" + s_id + "' && su_id='" + su_id + "')";
       ...
       * FOR Uploading All Projects Percentages    
     ...
     -------------------------------------------------------------------------------------------------------------------------------------------*/
            for (int i = 0; i < 1; i++)
            {
                ...
                for (int j = 0; j <= d; j++)
                {
                    ...
                    if (j == 0 && j != d)
                    {
                        tc.Text = "Project#1 Total percentage";
                    }
                    else if (j == 1 && j != d)
                    {
                        tc.Text = "Project#2 Total percentage";
                    }
                    else if (j == 2 && j != d)
                    {
                        tc.Text = "Project#3 Total percentage";
                    }
                    else if (j == 3 && j != d)
                    {
                        tc.Text = "Project#4 Total percentage";
                    }
                    else if (j == 4 && j != d)
                    {
                        tc.Text = "Project#5 Total percentage";
                    }
                    else if (j == d)
                    {
    ...
    protected void Maximum_Percentage_Click(object sender, EventArgs e)
    {
        ...
        Panel10.Visible = false;
        Label3.Visible = true;
        Label3.Text ="Maximum projects percentage that you can obtain";
        result = "maximum";
        generate1();
    }
    protected void Average_Percentage_Click(object sender, EventArgs e)
    {
        ...
        Panel10.Visible = false;
        Label3.Visible = true;
        Label3.Text ="Average projects percentage that you can obtain";
        result = "average";
        generate1();
    }
    protected void Minimum_Percentage_Click(object sender, EventArgs e)
    {
        ...
        Panel10.Visible = false;
        Label3.Visible = true;
        Label3.Text = "Minimum projects percentage that you can obtain";
        result = "minimum";
        generate1();
    }
    public void generate1()
    {
        ...
        MySqlCommand cmd1 = con.CreateCommand();
        cmd1.CommandType = CommandType.Text;
        cmd1.CommandText = "select p1,total_p1_marks,p2,total_p2_marks,p3,total_p3_marks,p4,total_p4_marks,p5,total_p5_marks,total_project_percentage from subject_result where srs_id=(select srs_id from student_registered_courses where s_id='" + s_id + "' && su_id='" + su_id + "')";
        MySqlDataReader ids = cmd1.ExecuteReader();
        while (ids.Read())
        {
            ...
            for (int i = 0; i < a; i++)
            {
                ...
                else
                {
                    ...
                    if (i == 0 || i == 2 || i == 4 || i == 6 || i == 8)
                    {
                        ...
                        if (i == 0)
                        {
                            rf.ErrorMessage = "Enter Project#1 textbox values! <br/>";
                        }
                        if (i == 2)
                        {
                            rf.ErrorMessage = "Enter Project#2 textbox values! <br/>";
                        }
                        if (i == 4)
                        {
                            rf.ErrorMessage = "Enter Project#3 textbox values! <br/>";
                        }
                        if (i == 6)
                        {
                            rf.ErrorMessage = "Enter Project#4 textbox values !<br/>";
                        }
                        if (i == 8)
                        {
                            rf.ErrorMessage = "Enter Project#5 textbox values! <br/>";
                        }
                        rf.CssClass = "fg-red";
