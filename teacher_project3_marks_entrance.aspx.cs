...
public partial class teacher_project3_marks_entrance : System.Web.UI.Page
{
    ...
    public void project3_button()
    {
        for (int j = 0; j < 1; j++)
        {
            ...
            for (int i = 0; i < 3; i++)
            {
                ...
                {
                    tc.Text = "Enter Project#3 Obtained Marks";
                }
                tr.Cells.Add(tc);
                tc.BorderWidth = 1;
        ...
        cmd1.CommandText = "select count(p3) from subject_result where srs_id=(select srs_id from student_registered_courses where su_id='" + su_id + "' limit 1)";
        ...
        else if (d == 1)
        {
            ...
            cmd2.CommandText = "select sd.s_id,sd.s_name,sr.p3,sr.total_p3_marks from student_detail sd,student_registered_courses src,subject_result sr where src.s_id=sd.s_id && src.srs_id=sr.srs_id && src.su_id ='" + su_id + "'";
            ...
            while (ids.Read())
            {
                ...
                Table1.Rows.Add(tr);
                a++;
                Total_p3_marks.Text = ids.GetString(3);
            }
            con.Close();
        }
