...
public partial class student_subject_quiz_result : System.Web.UI.Page
{
    ...
    public void show_quiz_result()
    {
        ...
        if (b == 1)
        {
            ...
            for (int i = 0; i < 1; i++)
            {
                ...
                for (int j = 0; j < a; j++)
                {
                    ...
                    if (j == 0)
                    {
                        tc.Text = "Quiz#1 Total Obtained Marks";
                    }
                    else if (j == 1)
                    {
                        tc.Text = "Quiz#1 Total Marks";
                    }
                    else if (j == 2)
                    {
                        tc.Text = "Quiz#2 Total Obtained Marks";
                    }
                    else if (j == 3)
                    {
                        tc.Text = "Quiz#2 Total Marks";
                    }
                    else if (j == 4)
                    {
                        tc.Text = "Quiz#3 Total Obtained Marks";
                    }
                    else if (j == 5)
                    {
                        tc.Text = "Quiz#3 Total Marks";
                    }
                    else if (j == 6)
                    {
                        tc.Text = "Quiz#4 Total Obtained Marks";
                    }
                    else if (j == 7)
                    {
                        tc.Text = "Quiz#4 Total Marks";
                    }
                    else if (j == 8)
                    {
                        tc.Text = "Quiz#5 Total Obtained Marks";
                    }
                    else if (j == 9)
                    {
                        tc.Text = "Quiz#5 Total Marks";
                    }
                    tc.Font.Bold = true;
                    tr.Cells.Add(tc);
                    tc.BorderWidth = 1;
            ...
            cmd1.CommandText = "select q1,total_q1_marks,q2,total_q2_marks,q3,total_q3_marks,q4,total_q4_marks,q5,total_q5_marks from subject_result where srs_id=(select srs_id from student_registered_courses where s_id='" + s_id + "' && su_id='" + su_id + "')";
         ...
         * FOR Uploading All Quizes Marks And Their Total Quiz Marks    
       ...
       -------------------------------------------------------------------------------------------------------------------------------------------*/
            for (int i = 0; i < 1; i++)
            {
                ...
                for (int j = 0; j <= d; j++)
                {
                    ...
                    if (j == 0 && j != d)
                    {
                        tc.Text = "Quiz#1 Total percentage";
                    }
                    else if (j == 1 && j != d)
                    {
                        tc.Text = "Quiz#2 Total percentage";
                    }
                    else if (j == 2 && j != d)
                    {
                        tc.Text = "Quiz#3 Total percentage";
                    }
                    else if (j == 3 && j != d)
                    {
                        tc.Text = "Quiz#4 Total percentage";
                    }
                    else if (j == 4 && j != d)
                    {
                        tc.Text = "Quiz#5 Total percentage";
                    }
                    else if (j == d)
                    {
    ...
    protected void Maximum_Percentage_Click(object sender, EventArgs e)
    {
        ...
        Label3.Visible = true;
        Label3.Text = "Maximum quizes percentage that you can obtain";
        result = "maximum";
        generate1();
    }
    protected void Average_Percentage_Click(object sender, EventArgs e)
    {
        ...
        Panel10.Visible = false;
        Label3.Visible = true;
        Label3.Text = "Average quizes percentage that you can obtain";
        result = "average";
        generate1();
    }
    protected void Minimum_Percentage_Click(object sender, EventArgs e)
    {
        ...
        Panel10.Visible = false;
        Label3.Visible = true;
        Label3.Text = "Minimum quizes percentage that you can obtain";
        result = "minimum";
        generate1();
    }
    public void generate1()
    {
        ...
        MySqlCommand cmd1 = con.CreateCommand();
        cmd1.CommandType = CommandType.Text;
        cmd1.CommandText = "select q1,total_q1_marks,q2,total_q2_marks,q3,total_q3_marks,q4,total_q4_marks,q5,total_q5_marks,total_quiz_percentage from subject_result where srs_id=(select srs_id from student_registered_courses where s_id='" + s_id + "' && su_id='" + su_id + "')";
        MySqlDataReader ids = cmd1.ExecuteReader();
        while (ids.Read())
        {
            ...
            for (int i = 0; i < a; i++)
            {
                ...
                else
                {
                    ...
                    if (i == 0 || i == 2 || i == 4 || i == 6 || i == 8)
                    {
                        ...
                        if (i == 0)
                        {
                            rf.ErrorMessage = "Enter Quiz#1 textbox values! <br/>";
                        }
                        if (i == 2)
                        {
                            rf.ErrorMessage = "Enter Quiz#2 textbox values! <br/>";
                        }
                        if (i == 4)
                        {
                            rf.ErrorMessage = "Enter Quiz#3 textbox values! <br/>";
                        }
                        if (i == 6)
                        {
                            rf.ErrorMessage = "Enter Quiz#4 textbox values !<br/>";
                        }
                        if (i == 8)
                        {
                            rf.ErrorMessage = "Enter Quiz#5 textbox values! <br/>";
                        }
                        rf.CssClass = "fg-red";
